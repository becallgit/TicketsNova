...
<head>
    ...
    <title>SOLICITUDES GLOBALES</title>
...
<nav class="navbar">
    ...
    <div class="container">
                <h2 style="text-align:center;">Listado de Todos los Tickets</h2>
    <form method="GET" action="{{ route('vista-solit-global') }}">
    ...
    <input type="text" name="asignado_a" placeholder="Asignado a" value="{{ request('asignado_a') }}">
        ...
        @if ($tickets->isEmpty())
            <p class="notickets">Aun no se han creado tickets.</p>
        @endif
    </div>
