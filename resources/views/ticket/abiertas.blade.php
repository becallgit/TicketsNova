...
@section('content')
    ...
    <div class="container">
                <h2 style="text-align:center;">Listado de Tickets Abiertos</h2>
    <form method="GET" action="{{ route('ver.abiertos') }}">
    <div class="filter-container">
        ...
        <a href="{{ route('ver.abiertos') }}"><i class="fa-solid fa-eraser"></i> Limpiar</a>
    </div>
</form>
